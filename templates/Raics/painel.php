                    ...
                    <table class="table table-hover align-middle text-nowrap">
                        ...
                        <tbody>
                            <?php foreach ($minha as $bol): ?>
                                <?php
                                $nomeCompleto = trim((string)($bol->nome_orientador ?? ''));
                                ...
                                $anoCertificado = !empty($bol->data_apresentacao)
                                    ...
                                    : (!empty($bol->fim_vigencia) ? date('Y', strtotime((string)$bol->fim_vigencia)) : date('Y'));
                                ?>
                                <tr>
                                    <td>
                                        <span class="fw-bold text-primary">#<?= h((string)($bol->id ?? '')) ?></span>
                                    </td>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <?= h((string)($bol->nome_bolsista ?? 'não informado')) ?>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td><?= h(!empty($bol->projeto_id) ? (string)$bol->projeto_id : '*Voluntário') ?></td>
