...
$nomeOpts = ['class' => 'form-control', 'maxlength' => 150, 'required' => true];
$emailOpts = ['type' => 'email', 'class' => 'form-control', 'maxlength' => 100, 'required' => true];
$emailAltOpts = ['type' => 'email', 'class' => 'form-control', 'maxlength'=>100];
?>
<?php if (!empty($cadastroNovo)) : ?>
    <?php if ($cpfTravado) : ?>
        <?=$this->Form->hidden('cpf_forcado', ['value' => $cpfForcado ?? $user->cpf ?? ''])?>
    <?php endif; ?>
    <?=$this->Form->hidden('edital_id', ['value' => $editalId ?? ''])?>
    <?=$this->Form->hidden('inscricao_id', ['value' => $inscricaoId ?? ''])?>
<?php endif; ?>
<script>
        ...
        <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-2"> 
                                <?=$this->Form->control('cpf', $cpfReadonly) ?>
                        </div>
                        <div class="col-12 col-md-10"> 
                                <?=$this->Form->control('nome', $nomeOpts) ?>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-12 col-md-4">
                                <?php
                                echo $this->Form->control('instituicao_curso', ['label'=>'Instituição de Ensino <small class="text-danger">*apenas a sigla</small>','class'=>'form-control', 'value' => ($user->instituicao->sigla ?? null),'escape' => false, 'maxlength'=>120, 'required'=>true]);
                                ?>
                        </div>
                    </div>
                    <div class="row g-3 mt-1">
            ...
            <div class="card mb-3 border-0 bg-light">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-3"> 
                                <?=$this->Form->control('email', $emailOpts) ?>
                        </div>
                        <div class="col-12 col-md-3"> 
                                <?=$this->Form->control('email_alternativo', $emailAltOpts) ?>
                        </div>
                        <div class="col-12 col-md-3"> 
