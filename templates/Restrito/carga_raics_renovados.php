    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    <h4 class="mb-2">Carga de RAIC para Renovados</h4>
                    <p class="text-muted mb-3">
                        Filtre inscrições de renovação do ano corrente para revisar a carga antes da criação dos registros em RAIC.
                    </p>
                    ...
                    <?= $this->Form->create(null, [
                        ...
                        <div class="col-md-3">
                            <?= $this->Form->control('editai_id', [
                                'label' => 'Edital Renovação',
                                'options' => $editaisRenovacao,
                                'empty' => 'Todos',
                        ...
                        <div class="col-md-12 d-flex gap-2">
                            ...
                            <?= $this->Html->link(
                                'Limpar',
                                ['controller' => 'Restrito', 'action' => 'cargaRaicsRenovados'],
                        ...
                        <div class="card border mb-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <span class="badge bg-light text-dark border">
                                        Edital:
                                        <?= !empty($filtros['editai_id']) && !empty($editaisRenovacao[$filtros['editai_id']])
                                            ? h($editaisRenovacao[$filtros['editai_id']])
                                            : 'Todos' ?>
                                    </span>
                                    <span class="badge bg-light text-dark border">
                                        Fase:
                                        <?= !empty($filtros['fase_id']) && !empty($fases[$filtros['fase_id']])
                                            ? h($fases[$filtros['fase_id']])
                                            : 'Todas' ?>
                                    </span>
                                    <span class="badge bg-light text-dark border">
                                        RAIC:
                    ...
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php foreach ($candidatos as $item): ?>
                                        <tr>
                                            ...
                                            <td><?= h((string)($item['fase_nome'] ?? 'Nao informado')) ?></td>
                                            ...
                                            <td><?= h((string)($item['programa'] ?? 'Nao informado')) ?></td>
                                            <td>
                        ...
                        <?= $this->Form->create(null, ['type' => 'post', 'id' => 'form-executar-carga-raic-renovados']) ?>
                            ...
                            <?= $this->Form->hidden('fase_id', ['value' => (int)($filtros['fase_id'] ?? 0)]) ?>
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <?= $this->Form->button('Executar Carga de Renovados', [
                                    'class' => 'btn btn-danger',
                                    'onclick' => "return confirm('Confirma a criacao de RAIC para todas as renovacoes elegiveis listadas na previa?');",
                                ]) ?>
                                <?= $this->Html->link(
                                    'Voltar',
