                            ...
                            <div class="border rounded bg-white p-3 p-md-4 mt-2">
                                ...
                                <div class="pt-2 border-top">
                                    <?= $this->Form->create(null, ['class' => 'd-grid d-md-flex justify-content-md-end']) ?>
                                        ...
                                        <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Deseja excluir o coorientador vinculado a esta substituição?');">Excluir coorientador</button>
                                    <?= $this->Form->end() ?>
                                </div>
                                <?php endif; ?>
                            </div>
