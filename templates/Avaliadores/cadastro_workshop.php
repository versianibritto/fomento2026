    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    <h4 class="mb-2">Cadastro Massivo de Avaliadores Workshop</h4>
                    <p class="text-muted mb-3">
                        Selecione o edital Workshop aberto e informe os CPFs separados por vírgula.
                    </p>
                    ...
                    <?= $this->Form->create(null, ['class' => 'row g-3']) ?>
                        ...
                        <div class="col-12 d-flex gap-2">
                            ...
                            <?= $this->Html->link(
                                'Limpar',
                                ['controller' => 'Avaliadores', 'action' => 'cadastroWorkshop'],
