<div class="container mt-4">
    <div class="py-2 mb-3 border-bottom text-center">
        <?= $this->element('pdj_renovacoes_steps', [
            'edital' => $edital,
        ...
        <div class="card-body">
            <div class="p-3 mb-4 bg-light border rounded text-center">
                ...
                <div class="text-muted mt-1">
                    O projeto do supervidor não pode ser alterado na renovação.<br>
            ...
            <?= $this->Form->create($projetoSelecionado, ['type' => 'file', 'class' => 'row g-3', 'id' => 'projeto-form']) ?>
                ...
                <?php
                    ...
                    $valorAreaPdj = isset($inscricao->area_pdj) && $inscricao->area_pdj !== null ? (int)$inscricao->area_pdj : null;
                    $valorAreaPdjTela = $valorAreaPdj !== null && isset($areasInscricaoPdj[$valorAreaPdj])
                        ? (string)$areasInscricaoPdj[$valorAreaPdj]
                        : '';
                ...
                <div class="col-12">
                    <div class="card border mb-2">
                        ...
                        <div class="col-12">
                            <?php if ($valorAreaPdj === null) : ?>
                                <?= $this->Form->control('area_pdj', [
                                    'label' => 'Área de inscrição PDJ',
                                    'type' => 'select',
                                    'options' => $areasInscricaoPdj ?? [],
                                    'empty' => ' - Selecione - ',
                                    'class' => 'form-select campo-vazio',
                                ]) ?>
                            <?php else : ?>
                                <div class="border rounded p-2 bg-light h-100">
                                    <div class="small text-muted">Área de inscrição PDJ</div>
                                    <div><?= h($valorAreaPdjTela !== '' ? $valorAreaPdjTela : $naoInformado) ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-6">
