        ...
        <div class="card-body">
            ...
            <?= $this->Form->create(null, ['type' => 'file', 'class' => 'row g-3']) ?>
                    ...
                    <div class="alert alert-warning border border-warning-subtle mb-0 sumula-alerta">
                        ...
                        <div class="card border border-warning-subtle bg-white mt-3">
                            <div class="card-body py-3">
                                <div class="row g-2 align-items-center anexos-areas">
                                    <div class="col-md-6">
                                        <label for="anexo-9" class="form-label mb-0"><?= h($anexoTipo9Nome ?? 'Anexo') ?></label>
                                    </div>
                                    <div class="col-md-6">
                                        <?php if (empty($anexoOrientadorAviso->anexo)) : ?>
                                            <?= $this->Form->control('anexos.9', [
                                                'label' => false,
                                                'id' => 'anexo-9',
                                                'type' => 'file',
                                                'class' => 'form-control',
                                            ...
                                            <div class="anexo-arquivo-atual">
                                                <div class="d-flex align-items-center justify-content-between gap-2 flex-nowrap">
                                                    <div class="small text-muted text-truncate">
                                                        <?= h($anexoOrientadorAviso->anexo) ?>
                                                    </div>
                                                    <div class="d-inline-flex align-items-center gap-1 flex-nowrap">
                                                        <a href="/uploads/anexos/<?= h($anexoOrientadorAviso->anexo) ?>" target="_blank" class="btn btn-light border btn-sm py-0 px-2" title="Download">
                                                            <i class="fa fa-download"></i>
                                                        </a>
                                                        <label for="anexo-9" class="btn btn-light border btn-sm py-0 px-2 mb-0" title="Alterar">
                                                            <i class="fa fa-edit"></i>
                                                        </label>
                                                        <button
                                                            type="button"
                                                            class="btn btn-light border-danger text-danger btn-sm py-0 px-2 mb-0"
                                                            onclick="confirmarExclusaoAnexo(9, this.form)"
                                                            title="Excluir"
                                                        >
                                ...
                                <?php if ($sexoLogado === 'F') : ?>
                                    <div class="row g-2 align-items-center mt-3 pt-3 border-top border-warning-subtle">
                                        <div class="col-md-6">
                                            <label for="filhos-menor" class="form-label mb-0">Supervidora, possui filhos menores de 8 anos?</label>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="col-12">
                            ...
                            <table class="table table-bordered align-middle mb-0 sumula-table">
                                ...
                                <tbody>
                                    <?php foreach ($sumulasEdital as $idx => $sumula) : ?>
                                        ...
                                        <tr>
                                            <td class="sumula-col-texto">
                                                <div><?= h($sumula->sumula) ?></div>
                    ...
                    <?php else : ?>
                        <div class="alert alert-info mb-0">Não há súmulas cadastradas para este edital.</div>
                    <?php endif; ?>
                </div>
