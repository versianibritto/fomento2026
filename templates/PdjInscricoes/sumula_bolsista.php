    ...
    <div class="card">
        <div class="card-body">
            <div class="p-3 mb-4 bg-light border rounded text-center">
                <h3 class="mb-2">Súmula do bolsista</h3>
            ...
            <?= $this->Form->create(null, ['class' => 'row g-3']) ?>
                <div class="col-12">
                    <div class="alert alert-warning border border-warning-subtle mb-0 sumula-alerta">
                        ...
                        <div>As súmulas que o bolsista não possuir devem ser preenchidas obrigatoriamente com valor 0 (zero).</div>
                    </div>
                </div>
