        ...
        <div class="card-body">
            ...
            <?= $this->Form->create($projetoSelecionado, ['type' => 'file', 'class' => 'row g-3', 'id' => 'projeto-form']) ?>
                ...
                <?php
                    ...
                    $valorAreaPdj = isset($inscricao->area_pdj) && $inscricao->area_pdj !== null ? (string)$inscricao->area_pdj : '';
                ...
                <div class="col-12">
                    <?= $this->Form->control('area_pdj', [
                        ...
                        'class' => 'form-select' . ($valorAreaPdj === '' ? ' campo-vazio' : ''),
                        'options' => $areasInscricaoPdj ?? [],
                        'empty' => ' - Selecione - ',
                        'value' => $inscricao->area_pdj ?? null,
                    ]) ?>
                </div>
                <div class="col-md-6">
