<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Filtros - Listagem Workshop</h4>
    ...
    <div class="card mb-3 shadow-sm listas-filtros-card">
        <div class="card-body">
            <?= $this->Form->create(null, [
                'type' => 'get',
                'url' => ['controller' => 'Listas', 'action' => 'resultadoWorkshop'],
                'class' => 'row g-3'
            ]) ?>
                <div class="col-12 listas-filtros-topo">
                    <div>
                        <div class="fw-semibold">Refinar listagem Workshop</div>
                        <small>Use os filtros para localizar os registros desejados.</small>
                    </div>
                    <span class="badge bg-light text-dark border">Workshop</span>
                </div>
                <div class="col-md-4">
