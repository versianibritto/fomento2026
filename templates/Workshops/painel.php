<?php
$identityWorkshopPainel = $this->request->getAttribute('identity');
$usuarioId = (int)($identityWorkshopPainel->id ?? 0);
$tiposBolsa = [
    'R' => 'Renovação',
    'V' => '**Workshops de Outras Agencias',
    'Z' => 'Workshops de Outras Agencias',
];
?>
...
<div class="p-3">
                            ...
                            <?php foreach ($minha as $bol): ?>
                                ...
                                <tr>
                                    <td>
                                        <?= $this->Html->link(
                                            '#' . h((string)($bol->id ?? '')),
                                            ['controller' => 'Workshops', 'action' => 'ver', $bol->id],
                                            ['class' => 'fw-bold text-primary text-decoration-none']
                                        ) ?>
                                    </td>
                                    <td>
                                        <?php if ((int)($bol->bolsista ?? 0) === $usuarioId): ?>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex flex-wrap gap-2 justify-content-end align-items-center">
                                            <?php if (strtoupper((string)($bol->presenca ?? '')) === 'S' && (int)($bol->bolsista ?? 0) === $usuarioId): ?>
                                                <?= $this->Html->link(
    ...
    <?php else: ?>
        <div class="card">
            <div class="card-body">
                <p class="text-muted mb-0">Nenhum registro de Workshop encontrado para o usuário logado.</p>
            </div>
        </div>
    <?php endif; ?>
</div>
