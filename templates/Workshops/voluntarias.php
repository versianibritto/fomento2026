<?= $this->Form->create($workshop, ['type' => 'file', 'id' => 'voluntarias']); ?>
<div class="container mt-4">
    <div class="card">
        <div class="card-body">
            <div class="p-3 mb-4 bg-light border rounded text-center">
                <h3 class="mb-2">Cadastro de Aluno na Workshop</h3>
                <div class="fw-semibold">Workshop Outras Agências de Fomento / Alunos Egressos</div>
                <div class="text-muted mt-1">Informe bolsista, orientador e dados da Workshop para concluir o cadastro manual.</div>
            </div>
