...
$cota = [
    'G' => 'Não desejo participar de cotas afirmativas',
...
$query = "select 
            ...
            where 
            pb.situacao='N' and pb.deleted=0 and pb.editai_id=26";
try
{
...
<table>
    ...
    foreach($rows as $r){
        $arquivo .= "<tr>
                    ...
                    <td style='text-align:center'>".utf8_decode($sexo[$r['sexo']])."</td>
                    ...
                    <td style='text-align:center'>".utf8_decode($cota[$r['cota']])."</td>
                    <td style='text-align:center'>".utf8_decode($programa[$r['programa']])."</td>
